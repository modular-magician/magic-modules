...
bundle exec compiler -v beta -p products/compute -t Address,GlobalAddress,Subnetwork,RegionDisk,VpnTunnel -e terraform -o "${GOPATH}/src/github.com/terraform-providers/terraform-provider-google/"
